...
export const SLOT_METADATA: Record<string, Omit<SlotMetadata, 'slotId' | 'roleName'>> = {
  ...
  'marshal.1': {
    ...
    details: {
      ...
      location: 'Kensington → 37th; 36th → Kensington finish',
  ...
  'marshal.2': {
    ...
    details: {
      ...
      location: 'Valleywood stretch; N. John Marshall → 36th',
  ...
  'marshal.3': {
    ...
    details: {
      ...
      location: 'Valleywood → Vermont; 35th → N. John Marshall',
  ...
  'marshal.4': {
    ...
    details: {
      ...
      location: 'Vermont → Massachusetts; Nottingham → 35th',
  ...
  'marshal.5': {
    ...
    details: {
      ...
      location: 'Mass → Rhode Island; Rockingham interchange',
  ...
  'marshal.7': {
    ...
    details: {
      routePoints: 'Zone 8',
      location: 'Virginia → Nottingham turn',
