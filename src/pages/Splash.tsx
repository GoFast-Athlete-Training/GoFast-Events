...
/**
 * Splash Page - Auth Gate
 * Matches MVP1 pattern: checks auth state and routes accordingly
 * 
 * Flow:
 * - Loading: Show loading spinner
 * - Authenticated + Returner (has young athlete): Show Welcome (MVP1 style) → home
 * - Authenticated + New: Create/get athleteId → redirect to parent-profile
 * - Not authenticated: Show ParentPreProfileExplainer
 */
const Splash = () => {
